...
// The above not as complex as it looks! You already know the parts of this -

// 1 we make a transaction
// 2 we make an instruction
// 3 we add the instruction to the transaction
// 4 we send the transaction to the network!
